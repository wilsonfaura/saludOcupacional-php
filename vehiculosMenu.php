...
{
	case "agregar";
		$contenido="php/vehiculosAgregarForm.php";
		$titulo = "Agregar Vehiculos";
		break;
	case "eliminar";
		$contenido="php/vehiculosEliminarForm.php";
		$titulo = "Eliminar Vehiculos";
		break;
	case "cambios";
		$contenido="php/vehiculosEditarForm.php";
		$titulo = "Editar Vehiculos";
		break;
	case "consultas";
		$contenido="php/vehiculosConsultarForm.php";
		$titulo = "Consultar Vehiculos";
		break;
	default:
		$contenido = "vehiculosHome.php";
...
<section id="contenido"> 
       <nav>
         <ul>
	        <li><a class="cambio" href="vehiculosMenu.php">HOME</a></li>
	        <li><a class="cambio" href="?op=agregar">AGREGAR VEHICULO</a></li>
            <li><a class="cambio" href="?op=eliminar">ELIMINAR VEHICULO</a></li>
            <li><a class="cambio" href="?op=cambios">EDITAR VEHICULO</a></li>
            <li><a class="cambio" href="?op=consultas">CONSULTAR VEHICULO</a></li>
         </ul>     
  </nav>
