...
if($_GET["inicio"] and $_GET["fin"]!=null)
{
	$inicio=$_GET["inicio"];
	$fin=$_GET["fin"];
	$consulta = "SELECT * FROM capacitacion WHERE capFecha BETWEEN '$inicio' AND '$fin'";
	include("capacitacionTabla-resutados.php");
}
?>
<br />
<a href="pdf/ReportesPdf/capacitacionRepFecha.php?dato=<?php echo $inicio?>&dato1=<?php echo $fin?>" title="Generar Pdf">Generar Pdf</a>