...
if($_GET["inicio"] and $_GET["fin"]!=null)
{
	$inicio=$_GET["inicio"];
	$fin=$_GET["fin"];
	$consulta = "SELECT * FROM entrega JOIN trabajador JOIN epp WHERE entTrabajador=identificacion AND entEpp=eppNombre AND entFecha BETWEEN '$inicio' AND '$fin'";
	include("php/eppEntregaTabla-resutados.php");
}
?>
<br />
<a href="pdf/ReportesPdf/entregasRepFecha.php?dato=<?php echo $inicio?>&dato1=<?php echo $fin?>" title="Generar Pdf">Generar Pdf</a>