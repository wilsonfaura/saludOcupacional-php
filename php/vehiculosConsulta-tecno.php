...
if($_GET["inicio"] and $_GET["fin"]!=null)
{
	$inicio=$_GET["inicio"];
	$fin=$_GET["fin"];
	$consulta = "SELECT * FROM vehiculo JOIN trabajador WHERE vehIdTra=identificacion AND vehTecno BETWEEN '$inicio' AND '$fin'";
	include("vehiculosTabla-resutados.php");
}
?>
<br />
<a href="pdf/ReportesPdf/vehiculosRepTecno.php?dato=<?php echo $inicio?>&dato1=<?php echo $fin?>" title="Generar Pdf">Generar Pdf</a>