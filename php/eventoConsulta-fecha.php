...
if($_GET["inicio"] and $_GET["fin"]!=null)
{
	$inicio=$_GET["inicio"];
	$fin=$_GET["fin"];
	$consulta = "SELECT * FROM evento JOIN trabajador WHERE evIdTrabajador=identificacion AND evFecha BETWEEN '$inicio' AND '$fin'";
	include("eventoTabla-resutados.php");
}
?>
<br />
<a href="pdf/ReportesPdf/eventoRepFecha.php?dato=<?php echo $inicio?>&dato1=<?php echo $fin?>" title="Generar Pdf">Generar Pdf</a>