...
if($_GET["inicio"] and $_GET["fin"]!=null)
{
	$inicio=$_GET["inicio"];
	$fin=$_GET["fin"];
	$consulta = "SELECT * FROM actividad WHERE actFechaIni BETWEEN '$inicio' AND '$fin'";
	include("actividadTabla-resutados.php");
}
?>
<br />
<a href="pdf/ReportesPdf/actividadRepFecha.php?dato=<?php echo $inicio?>&dato1=<?php echo $fin?>" title="Generar Pdf">Generar Pdf</a>