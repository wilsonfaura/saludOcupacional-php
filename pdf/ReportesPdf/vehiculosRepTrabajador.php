...
$pdf->Cell(191,10,'LISTADO DE VEHICULOS POR TRABAJADOR', 1 ,1, 'C');
...
$sql="SELECT * FROM vehiculo JOIN trabajador WHERE vehIdTra=identificacion AND vehIdTra like '%$dato%'";
