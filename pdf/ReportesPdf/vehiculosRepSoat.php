...
$pdf->Cell(191,10,'LISTADO DE VEHICULOS POR SEGURO CONTRA ACCIDENTES DE TRANSITO', 1 ,1, 'C');
...
$sql="SELECT * FROM vehiculo JOIN trabajador WHERE vehIdTra=identificacion AND vehSoat BETWEEN '$dato' AND '$dato1'";
