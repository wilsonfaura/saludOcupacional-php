...
$pdf->Cell(208,10,'LISTADO DE EVENTOS POR FECHA', 1 ,1, 'C');
...
$sql="SELECT * FROM evento JOIN trabajador WHERE evIdTrabajador=identificacion AND evFecha BETWEEN '$dato' AND '$dato1'";
