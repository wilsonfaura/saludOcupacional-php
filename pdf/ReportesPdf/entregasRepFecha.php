...
$pdf->Cell(199,10,'LISTADO DE ENTREGAS EPP POR FECHA', 1 ,1, 'C');
...
$sql="SELECT * FROM entrega JOIN trabajador JOIN epp WHERE entTrabajador=identificacion AND entEpp=eppNombre AND entFecha BETWEEN '$dato' AND '$dato1'";
