...
$pdf->Cell(205,10,'LISTADO DE EVENTOS POR TRABAJADOR', 1 ,1, 'C');
...
$sql="SELECT * FROM evento JOIN trabajador WHERE evIdTrabajador=identificacion AND evIdTrabajador like '%$dato%'";
