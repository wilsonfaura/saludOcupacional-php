...
$pdf->Cell(199,10,'LISTADO DE ENTREGAS EPP POR TRABAJADOR', 1 ,1, 'C');
...
$sql="SELECT * FROM entrega JOIN trabajador JOIN epp WHERE entTrabajador=identificacion AND entEpp=eppNombre AND entTrabajador like '%$dato%'";
